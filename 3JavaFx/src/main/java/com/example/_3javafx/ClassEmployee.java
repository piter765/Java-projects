...
public class ClassEmployee implements Comparator<String> {
    ...
    public List<Employee> getListaPracownikow() {return listaPracownikow;}
    public int getMaksymalnaIloscPracownikow() {return maksymalnaIloscPracownikow;}
    ...
    public double calculateOccupancy() {
       double occupancy = (double) listaPracownikow.size() / (double) maksymalnaIloscPracownikow * 100;
       return occupancy;
    }
